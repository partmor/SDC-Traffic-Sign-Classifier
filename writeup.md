...
## Writeup
---
In this project, I apply deep neural networks and convolutional neural networks to classify German traffic signs. This document supports my [project code](Traffic_Sign_Classifier.ipynb), providing a detailed description of each stage of the data pre-processing pipeline, model training, and model assessment.
...
*[Cells 1 - 10 of the project code]*
...
### Model Architecture
*[Cells 24-25 of the project code]*
...
In order to easilly construct the final architecture *[cell 25]* and improve modularity of the code, the CN-Subsampling-Activation, and FC-Activation *blocks* are encapsulated in *[cell 24]*.

### Model training
*[Cells 28-34 of the project code]*
...
*[Cells 35-42 of the project code]*
...
*[Cells 43-47 of the project code]*
